 ...
 * @author burak
 */
public class FXMLFaturasizSatisController implements Initializable {
    ...
    @FXML
    private void onMouseActionmenuItemPesinSatis() {

    }
    
    @FXML
    private void onMouseActionmenuItemCekSenet() {
